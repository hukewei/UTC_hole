...
$accesstoken='233943|6.67hddsahhdkjahsdhsaf070a39f7c.2592000.1370620800-2783232123';//改成测试用户的
...
/*测试1：获取指定用户的信息
 */
$params = array('uids'=>'278365310','fields'=>'uid,name,sex,birthday,mainurl,hometown_location,tinyurl,headurl,mainurl','access_token'=>$accesstoken);
...
*测试发送消息给公共主页
*/
$params = array('page_id'=>'601722988','status'=>'helloworld!','access_token'=>$accesstoken);
