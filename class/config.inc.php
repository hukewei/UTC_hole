...
$config->APIKey		= 'dd3ffbfafsdafdsafasd5dbc82c2f39c';	//你的API Key，请自行申请
$config->SecretKey	= 'f6d6d1308e3fsfsfddsf955ba2sadac0';	//你的API 密钥
$config->APIVersion	= '1.0';	//当前API的版本号，不需要修改
$config->decodeFormat	= 'json';	//默认的返回格式，根据实际情况修改，支持：json,xml

$config->redirecturi= 'http://utc.kekebox.com/accesstoken.php';//你的获取code的回调地址，也是accesstoken的回调地址
